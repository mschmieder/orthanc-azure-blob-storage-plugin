...
static OrthancPlugins::AzureBlobStorageArea* storage_ = nullptr;
...
//    mongoc_init();
    ...
    try
    {
      std::unique_ptr<OrthancPlugins::AzureBlobStorageConnection> pg(OrthancPlugins::CreateConnection(context_, configuration));
